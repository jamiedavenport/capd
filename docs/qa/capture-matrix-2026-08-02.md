...
| --- | ------- | ----------------------------------- | --------------------------------------- | ------ | --------------------- |
| 1   | Safari  | Paragraph selected on article page  | title+URL+selection, `body_source=tab`  | ⚠️     | Body source was fetch |
...
| 4   | Chrome  | Paragraph selected on article page  | title+URL+selection, `body_source=tab`  | ⚠️     | Body source was fetch |
...
| 7   | Arc     | Paragraph selected on article page  | title+URL+selection, `body_source=tab`  | ⚠️     |                       |
...
| --- | ------------------ | ----------------------------------------------------------------------------- | ------ | ------------------------------------------------------ |
| 10  | Paragraph selected | text capture, correct bundle id, **no** URL/title claiming to be from the tab | ❌     | No selection, correct bundle ID, URL and title correct |
| 11  | No selection       | ⌘C fallback; text-less outcome handled cleanly, no junk row                   | ❌     | Works perfectly with URL and title!!                   |
...
| #   | Case                          | Expected                                                | Result | Notes                       |
| --- | ----------------------------- | ------------------------------------------------------- | ------ | --------------------------- |
| 12  | Text selected in Electron app | text capture, correct `source_app_bundle_id`, no URL    | ❌     | Nothing to capture (VSCode) |
...
| 15  | PDF open in a Safari/Chrome tab     | title+URL land; tab HTML is useless so `body_source=fetch` | ❌     | Not a caputable link error |
