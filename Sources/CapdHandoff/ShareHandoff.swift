...
/// The `capd://capture` URL that carries a shared page from the share extension — or any
/// outside caller — into the app.
public enum ShareHandoff {
    public static let scheme = "capd"
    ...
    /// Rejects anything but a well-formed `capd://capture` link to a web URL: the scheme
